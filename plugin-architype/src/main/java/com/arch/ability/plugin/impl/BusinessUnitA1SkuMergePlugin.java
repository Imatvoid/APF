...
@RegisterPlugin(businessUnitNoKeys = {"businessIdentity.businessUnitNo.A1"})
public class BusinessUnitA1SkuMergePlugin extends Plugin implements SkuMergeAbilityPoint {
    // 特殊行号处理的事业部
    ...
    public void generateSkuMergeKeyReceiveSaleOrder(SkuMergeKeyCmd cmd) {
        ...
        // 特殊实现,需要把批次属性加进合并区分维度.
        builder.append("_").append(cmd.getBatchAttribute());
